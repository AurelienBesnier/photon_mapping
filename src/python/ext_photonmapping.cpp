...
void visualizePhotonMap(const PhotonMapping &integrator, const Scene &scene, Image &image, const unsigned &height,
...
void visualizeCaptorsPhotonMap(const Scene &scene, Image &image, const unsigned &height,
                               const unsigned &width, const Camera &camera,
                               const unsigned &n_photons, const unsigned &max_depth,
                               const std::string_view &filename, UniformSampler &sampler,
...
//#pragma omp parallel for collapse(2) schedule(dynamic, 1)
    for (unsigned int i = 0; i < height; ++i) {
        ...
        std::cout << "rendering scanline " << i + 1 << "/" << height << "..." << std::endl;
...
PYBIND11_MODULE(libphotonmap_core, m) {
    ...
    py::bind_vector<std::vector<unsigned char>>(m, "VectorUchar",
                                                py::module_local(false));
    py::bind_vector<std::vector<Triangle>>(m, "VectorTriangle",
                                           py::module_local(false));
    ...
    py::class_<KdTree<Photon>>(m, "KdTree")
            ...
            .def("setPoints", &KdTree<Photon>::setPoints,
                 "Sets the points of the kdtree", py::arg("points"),
                 py::arg("nPoints"));
    ...
    py::class_<PhotonMap>(m, "PhotonMap")
            ...
            .def("queryKNearestPhotons", &PhotonMap::queryKNearestPhotons,
                 "Returns the k nearest photons of the photon p", py::arg("p"),
                 py::arg("k"), py::arg("max_dist2"));
    ...
    py::class_<Image>(m, "Image")
            ...
            .def("setPixel", &Image::setPixel, py::arg("i"), py::arg("j"),
                 py::arg("rgb"))
            .def("divide", &Image::divide, "Divide all the pixel of the image by k",
                 py::arg("k"))
    ...
    py::class_<Primitive>(m, "Primitive")
            ...
            .def("evaluateBxDF", &Primitive::evaluateBxDF, py::arg("wo"),
                 py::arg("wi"), py::arg("surfInfo"), py::arg("mode"))
            .def("sampleBxDF", &Primitive::sampleBxDF, py::arg("wo"),
                 py::arg("surfInfo"), py::arg("mode"), py::arg("sampler"),
                 py::arg("wi"), py::arg("pdf"))
            .def("sampleAllBxDF", &Primitive::sampleAllBxDF, py::arg("wo"),
                 py::arg("surfInfo"), py::arg("mode"));
    ...
    py::class_<UniformSampler, Sampler>(m, "UniformSampler")
            ...
            .def("getNext1D", &UniformSampler::getNext1D,
                 py::return_value_policy::reference)
            .def("getNext2D", &UniformSampler::getNext2D,
                 py::return_value_policy::reference);

    m.def("sampleCosineHemisphere", &sampleCosineHemisphere, py::arg("uv"),
          py::arg("pdf"));
    ...
    py::class_<Vec3<uint32_t>>(m, "Vec3Ui")
            ...
            .def(float() * py::self)
            .def(py::self * float())
            .def("__setitem__", [](Vec3<uint32_t> &self, int index,
                                   uint32_t val) { self[index] = val; })
            .def("__getitem__",
    ...
    py::class_<Scene>(m, "Scene")
            ...
            .def("addFaceInfosMat", &Scene::addFaceInfosMat, py::arg("vertices"),
                 py::arg("indices"), py::arg("normals"), py::arg("material"))
            .def("addFaceInfos", &Scene::addFaceInfos, py::arg("vertices"),
                 ...
                 py::arg("reflectance"), py::arg("transmittance"), py::arg("roughness"))
            ...
            .def("sampleLight",
                 py::overload_cast<Sampler &, float &>(&Scene::sampleLight,
                                                       py::const_),
                 py::arg("sampler"), py::arg("pdf"))
            .def("sampleLight",
                 py::overload_cast<float &, unsigned int>(&Scene::sampleLight, py::const_),
                 py::arg("pdf"), py::arg("idx"))
    ...
    m.def("Render", &Render,
          "Function to render the scene to an image from the camera perspective",
          py::arg("sampler"), py::arg("image"), py::arg("height"),
          py::arg("width"), py::arg("n_samples"), py::arg("camera"),
          py::arg("integrator"), py::arg("scene"), py::arg("filename"));

    m.def("visualizePhotonMap", &visualizePhotonMap,
          "Function to visualize the photonmap as a .ppm image", py::arg("integrator"), py::arg("Scene"),
