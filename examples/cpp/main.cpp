...
void Render(UniformSampler& sampler, Image& image, const int &height, const int &width, const int &n_samples, const Camera& camera, PhotonMapping& integrator, const Scene& scene)
{
